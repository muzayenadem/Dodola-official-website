...
function Subscribe() {
  return (
    <div className="py-10">
        <section class="flex flex-col max-w-4xl mx-auto overflow-hidden bg-black/5 rounded-lg shadow-lg dark:bg-gray-800 md:flex-row md:h-48">
    <div class="md:flex md:items-center md:justify-center md:w-1/2 md:bg-gray-700 md:dark:bg-gray-800">
        <div class="px-6 py-6 md:px-8 md:py-0">
            <h2 class="text-lg font-bold text-gray-700 dark:text-white md:text-gray-100">Keep in touch for <span class="text-blue-600 dark:text-blue-400 md:text-blue-300">New Information</span> Updates</h2>

            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400 md:text-gray-400">please feel free to be our member to get further knowdloge about dodola city</p>
        </div>
    </div>
