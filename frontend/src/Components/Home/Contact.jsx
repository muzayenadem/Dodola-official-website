        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">dodola@gmail..com</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">bus station arround</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+251 36591302</p>
                </div>
            </div>
