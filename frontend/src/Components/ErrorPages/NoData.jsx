...
function NoData() {
  return (
    ...
    <div class="max-w-md w-full space-y-8 text-center">
        <div class="mb-8">
        <h2 class="mt-6 text-6xl font-extrabold text-gray-900 dark:text-gray-100">No content yet</h2>
        <p class="mt-2 text-3xl font-bold text-gray-700 dark:text-gray-100">We will post the content releated to this category as soon as possible</p>
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Please stay patient untill we post new content here</p>
        </div>
        <div class="mt-8">
         <Link to={`/`}
