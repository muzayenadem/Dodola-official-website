  ...
  return (
    <section className='bg-neutral-100 md:py-5 dark:bg-gray-900'>
           ...
           <div className="grid grid-cols-1 gap-3 md:grid-cols-12">
              <div className=" md:col-span-4 lg:col-span-3 bg-neutral-100  dark:bg-gray-900 h-auto max-h-[56vh]  md:sticky top-14  md:top-16"><ButtonsOfNews latest={latest}/></div>
              <div className={`md:col-span-6 bg-white dark:bg-gray-800 ${news.length ? '' : 'min-h-[100vh]'} `}><NewsCard data={data}/></div>
              <div className={`hidden md:block md:col-span-2 lg:col-span-3 bg-neutral-100 dark:bg-gray-900 h-auto ${news.length ? ' max-h-[64vh]' : 'max-h-[24vh]'} sticky top-16`}><LatestNews latest={latest}/></div>
           </div>
        </div>
