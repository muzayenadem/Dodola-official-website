...
function ShareArea({data}) {
    ...
    switch (platform) {
      ...
      case "linkedin":
        ...
        case "instagram":
          ...
          break;
        case "gmail":
          window.open(`https://mail.google.com/mail/?view=cm&fs=1&to=&su=&body=${encodeURIComponent(shareURL)}`, "_blank");
      case "copy":
  ...
  return (
    <div className="">
      ...
      <button onClick={() => handleShare("linkedin")} class="group transition-all duration-500 hover:-translate-y-2">
      ...
      <button  onClick={() => handleShare("telegram")} class="group transition-all duration-500 hover:-translate-y-2">
      ...
      <button  onClick={() => handleShare("gmail")} class="group transition-all duration-500 hover:-translate-y-2">
      ...
      <button onClick={() => handleShare("instagram")} class="group transition-all duration-500 hover:-translate-y-2">
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
      ...
      <button  onClick={() => handleShare("twitter")} class="group transition-all duration-500 hover:-translate-y-2">
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
      ...
      <button onClick={() => handleShare("whatsapp")} class="group transition-all duration-500 hover:-translate-y-2">
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
      ...
      <button  onClick={() => handleShare("copy")} class="group transition-all duration-500 hover:-translate-y-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 92 92" fill="none">
          <rect x="0.138672" y="1" width="91.5618" height="91.5618" rx="15" fill="#B0BEC5"/>
          <path d="M58.6065 17.6165H33.6935C31.1255 17.6165 28.9895 19.7525 28.9895 22.3205V61.2795C28.9895 63.8475 31.1255 66.0085 33.6935 66.0085H58.6065C61.1745 66.0085 63.3095 63.8475 63.3095 61.2795V22.3205C63.3095 19.7525 61.1745 17.6165 58.6065 17.6165ZM58.6065 61.2795H33.6935V22.3205H58.6065V61.2795Z" fill="white"/>
          <path d="M50.4883 30.7742C52.2308 30.7742 53.5661 29.4389 53.5661 27.6964C53.5661 25.9539 52.2308 24.6186 50.4883 24.6186C48.7458 24.6186 47.4105 25.9539 47.4105 27.6964C47.4105 29.4389 48.7458 30.7742 50.4883 30.7742Z" fill="white"/>
          <path d="M36.1546 12.8775C36.1546 14.0909 35.2603 15.1245 34.0393 15.1245C32.8183 15.1245 31.924 14.0909 31.924 12.8775C31.924 11.6641 32.8183 10.6305 34.0393 10.6305C35.2603 10.6305 36.1546 11.6641 36.1546 12.8775Z" fill="white"/>
        </svg>
      </button>
          </div>
        </div>
