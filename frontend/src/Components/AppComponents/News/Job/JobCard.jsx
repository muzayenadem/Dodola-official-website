...
function JobCard({data}) {
  ...
  return (
    ...
    <div class="max-w-3xl mx-auto">
        <div
            class="mt-3 bg-white p-5 rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
            <div class="">

                <a href="#" class="text-indigo-600 hover:text-gray-700 transition duration-500 ease-in-out text-sm">
                    {job.category}
                </a>
                <h1 href="#" class="text-gray-900 font-bold text-4xl">{job.title}</h1>
                <div class="py-5 text-sm font-regular text-gray-900 flex">
                    <span class="mr-3 flex flex-row items-center">
                       <svg class="text-indigo-600 h-['13px'] w-['13px'] "  fill="currentColor"  version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style={{background:"new 00 512 512",height:"13px",width:"13px"}} xml:space="preserve">
                        <g><g>
                    ...
                    <a href="#" class="flex flex-row items-center hover:text-indigo-600  mr-3">
                        ...
                        <span class="ml-1">{job.deadline}</span></a>
                    ...
                    <a href="#" class="flex flex-row items-center hover:text-indigo-600">
                        ...
                        <span class="ml-1">{job.type}</span></a>
                </div>
                <hr/>
                ...
                <h3 class="text-2xl font-bold my-5">#1. What is Requirements?</h3>
