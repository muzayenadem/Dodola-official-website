...
import { bank1 } from '../../Images/images'

function BanksTop() {
  return (
     
            <section class="relative  bg-gradient-to-br from-blue-900 to-indigo-800 font-sans text-white overflow-hidden">
                <div class="absolute inset-0 bg-black opacity-50"></div>
                <div class="absolute inset-0 bg-cover bg-center" style={{backgroundImage: `url(${bank1})`,opacity:'0.5'}}></div>
                ...
                <div class="container mx-auto px-4 py-24 md:py-32 relative z-10">
                    <div class="flex flex-col md:flex-row items-center justify-between">
                        <div class="w-full md:w-1/2 mb-12 md:mb-0">
                            ...
                            <p class="text-xl mb-8 text-gray-300 capitalize">The banks those are dodola city</p>
                        ...
                        <div class="w-full md:w-1/2 md:pl-12">
                            <div class="bg-white  bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-2xl">
                                <h2 class="text-2xl font-semibold mb-6">Why Dodola with banks?</h2>
                                <ul class="space-y-4">
