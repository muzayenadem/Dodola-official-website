...
function ResourtsCard({resourts}) {
            ...
            return (
                ...
                <div className="mt-8">
                    ...
                    <div className="flex items-center justify-between mt-4">
                     ...
                     <Link to={`/content-detail/${data._id}`} href="#" className="inline-block text-blue-500 underline hover:text-blue-400">Read more</Link>
                    </div>
