...
<form  onSubmit={nextHandler}>
  <div className="space-y-12">
    <div className="border-b border-gray-900/10 dark:border-neutral-600 pb-12">
      <h2 className="text-base font-semibold leading-7 text-gray-900 dark:text-white/80">New Job Post</h2>
    ...
    <div className="border-b border-gray-900/10 dark:border-neutral-600 pb-12">
      ...
      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8  sm:grid-cols-6">
        ...
        <div className="sm:col-span-2 sm:col-start-1">
          ...
          <div className="mt-2">
            <input onChange={(e)=> setCompany({...company,companyName:e.target.value})}  type="text"  
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-2">
            <input onChange={(e)=> setCompany({...company,companyEmail:e.target.value})} type="email"   
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-2">
            <input onChange={(e)=> setCompany({...company,companyPhone:e.target.value})} type="number"
    ...
    <div className='w-52'>
      ...
      <input onChange={(e) => setPostData({...postData,deadline:e.target.value})} type="date" placeholder="Dead Line" 
