...
function LoginAdmin() {
  ...
  return (
    ...
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form onSubmit={loginHandler} class="w-full max-w-md">
            ...
            <div class="relative flex items-center mt-8">
                ...
                <input onChange={(e)=> setAdmin({...admin,email:e.target.value})} type="email" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email address"/>
            </div>
            ...
            <div class="relative flex items-center mt-4">
                ...
                <input onChange={(e)=> setAdmin({...admin,password:e.target.value})} type="password" class="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password"/>
            </div>
            ...
            <div class="mt-6">
                ...
                <a href={`${serverLink}/auth/google`} class="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
