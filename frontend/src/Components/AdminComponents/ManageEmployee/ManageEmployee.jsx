...
import EmployeeTopButton from './EmployeePlace/EmployeeTopButton'
import ListOfEmployee from './EmployeePlace/ListOfEmployee'
import employeeData from '../../ComponentsData/employeeData'
...
function ManageEmployee() {
  ...
  return (
    <div className='flex flex-col py-12 gap-5 min-h-[100vh]'> 
       <EmployeeTopButton/>
       <ListOfEmployee employee={employee} data={data}/>
     </div>
  )
}
