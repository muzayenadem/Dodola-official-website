...
function UnPuplishContentPopUp({setOpenPublish,id}) {
  return (
    <div className='bg-white shadow-lg dark:bg-gray-900 dark:text-white/80  shadow-neutral-700 gap-3 flex-col flex p-5 z-10 rounded-md w-[90%]  md:w-[35%] top-[20%] fixed left-[5%] md:left-[32%]'>
      ...
      <p className='text-xl font-semibold'>Are you certain you want to unpublish this content?</p>
      <span onClick={()=> setOpenPublish(false)} className='text-2xl'><MdOutlineClear/></span>
      </div>
      <p>
      Do you want to view out this content for the next period? Then all you have to do is change the availability.</p>
...
export default UnPuplishContentPopUp