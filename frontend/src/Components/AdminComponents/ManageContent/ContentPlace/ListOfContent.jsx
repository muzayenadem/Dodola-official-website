...
import ContentDeletePopUp from './PopUps/ContentDeletePopUp';
import UnPuplishContentPopUp from './PopUps/UnPuplishContentPopUp';
  ...
  return (
    ...
    <ContentPages/>
        <dialog open={openDelete}>
            <ContentDeletePopUp openDelete={setOpenDelete} id={openId}/>
        </dialog>
        <dialog open={openPublish}>
            <UnPuplishContentPopUp setOpenPublish={setOpenPublish} id={openId}/>
        </dialog>
    </>
  )
}
